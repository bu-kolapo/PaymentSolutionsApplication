...
//     */
//    FraudCheckResponse analyzeFraud(UUID paymentId);
//
//    /**
...
//    void updateFraudRule(String ruleType, double threshold);
    ...
    FraudCheckResponse evaluatePayment(UUID id);

    void blockEntity(String entityType, String entityId, String reason);
}
